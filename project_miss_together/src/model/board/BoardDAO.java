...
public class BoardDAO {
	...
	public ArrayList<BoardVO> selectAllbyPage(int page) { // 최근날짜순으로 게시판에 나열
		...
		ArrayList<BoardVO> datas = new ArrayList<>();
		//*****************************************************************************************************************************
		// 우선 한 페이지에 8개의 공지를 보여주는 것으로 코드를 짜보았습니다. 10개도 가능하지만 페이징이 잘 되는지 여부를 확인하는것이 목적이므로 굳이 공지를 많이 만들필요는 없다고 생각하기 떄문입니다.
		// page=1로 넘어오면 최근 공지 1~8, page=2라면 공지 9~16.. 이런식으로 board테이블에서 가져올 예정
		//*****************************************************************************************************************************
